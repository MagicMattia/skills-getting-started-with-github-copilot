...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Practice: Tuesdays & Thursdays, 4:00 PM - 6:00 PM; Games: Saturdays",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "rafa@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Casual and competitive basketball sessions to develop skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["jordan@mergington.edu", "tay@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["lila@mergington.edu", "noah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stagecraft, and production for school performances",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["maria@mergington.edu", "kyle@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking, argumentation, and participate in tournaments",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["harper@mergington.edu", "sam@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, guest speakers, and science fair preparation",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "li@mergington.edu"]
    }
}
...
def get_activity_participants(activity_name: str):
    """Restituisce la lista dei partecipanti per una attività"""
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
